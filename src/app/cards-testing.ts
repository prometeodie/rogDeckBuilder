...
export const testCards: Card[] = [
  { id: '1',  name: 'León de Marte', faction: 'marte', rarity: 'common',     img: img1, factionCost: 1, cost: 2, banned: false, isSeal: false, isQuickSpell: false, isSlowSpell: false, isArtifact: false, isToken: false },
  { id: '2',  name: 'Hechicera Solar', faction: 'jupiter', rarity: 'rare',    img: img2, factionCost: 2, cost: 3, banned: false, isSeal: false, isQuickSpell: true,  isSlowSpell: false, isArtifact: false, isToken: false },
  ...
  { id: '5',  name: 'Explosión de Plasma', faction: 'jupiter', rarity: 'rare', img: img2, factionCost: 2, cost: 2, banned: false, isSeal: false, isQuickSpell: true,  isSlowSpell: false, isArtifact: false, isToken: false },
  ...
  { id: '15', name: 'Tiburón del Hielo', faction: 'neptuno', rarity: 'common', img: img3, factionCost: 1, cost: 3, banned: false, isSeal: false, isQuickSpell: false, isSlowSpell: false, isArtifact: false, isToken: false },
